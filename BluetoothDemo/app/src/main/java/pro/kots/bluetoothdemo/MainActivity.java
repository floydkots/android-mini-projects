package pro.kots.bluetoothdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void turnBluetoothOff(View view) {
        BA.disable();
        if (BA.isEnabled()) {
            toast("Bluetooth could not be turned off");
        } else {
    ...
    public void viewPairedDevices(View view) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, pairedDevicesArrayList);
